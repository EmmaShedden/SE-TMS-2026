...
If Pr(>Chisq) < 0.05 → m1 is significantly better than m0
    ✅ Keep m1, since the extra parameter improves model fit.
If Pr(>Chisq) > 0.05 → No significant difference
    ❌ Prefer m0 (simpler model), since m1 doesn’t improve fit enough.
If AIC is lower in m1 but p > 0.05
    If the AIC difference is ≥ 2, consider m1.
    If ΔAIC < 2, prefer the simpler m0.
